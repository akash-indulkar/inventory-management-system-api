...
import { adminLoginSchema, adminSignupSchema, passwordResetConfirmSchema, passwordResetRequestSchema } from "../validators/admin.schema";

const router = Router();

router.post("/signup", validate(adminSignupSchema), adminController.createAdmin);
